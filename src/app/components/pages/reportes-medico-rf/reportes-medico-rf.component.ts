...
export class ReportesMedicoRfComponent {
  ...
  registroDiario(): void {
    this.generar('diario', `/RegistroDiarioFisica/${this.fecha}`, 'RegistroDiarioRF.pdf');
  }
  consolidadoMensual(): void {
    this.generar('consolidado', `/ConsolidadoMensualTerapia/${this.mes}/${this.year}`, 'ConsolidadoRF.pdf');
  }
  morbilidad(): void {
    this.generar('morbilidad', `/MorbilidadTerapia/${this.mes}/${this.year}`, 'MorbilidadRF.pdf');
  }
}
